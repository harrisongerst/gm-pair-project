...
export default function FormModal() {
	...
	const [badHabitChecked, setBadHabitChecked] = useState(false);
	...
	const SignupSchema = Yup.object().shape({
		...
		description: Yup.string()
			...
			.max(100, 'Too Long!')
			.required('Required'),
		completeAmount: Yup.number().min(1, 'Enter a number').required('Required'),
	});
